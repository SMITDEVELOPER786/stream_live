...
class CustomTextFormField extends StatelessWidget {
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        fillColor: fillColor ?? appTheme.blue5005,
        filled: filled,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get fillBlueTL252 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(25.h),
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get fillBlueTL251 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(25.h),
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get fillBlueTL151 => OutlineInputBorder(
