...
class CustomDropDown extends StatelessWidget {
          ...
          items: items?.map((SelectionPopupModel item) {
            return DropdownMenuItem<SelectionPopupModel>(
              ...
              child: Text(
                ...
                style: hintStyle ?? CustomTextStyles.labelLargeWhiteA70001_1,
              ),
            );
          }).toList(),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.labelLargeWhiteA70001_1,
        prefixIcon: prefix,
...
extension DropDownStyleHelper on CustomDropDown {
  ...
  static OutlineInputBorder get fillBlueTL25 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(25.h),
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get fillGrayTL103 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.h),
        borderSide: BorderSide.none,
      );
  ...
  static OutlineInputBorder get fillGrayTL104 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.h),
        borderSide: BorderSide.none,
      );
  ...
  static OutlineInputBorder get fillBlueTL101 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.h),
        borderSide: BorderSide.none,
      );
