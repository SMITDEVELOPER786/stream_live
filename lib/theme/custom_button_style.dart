...
class CustomButtonStyles {
  ...
  static ButtonStyle get fillAmberTL10 => ElevatedButton.styleFrom(
        backgroundColor: appTheme.amber70001,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10.h),
        ),
      );
  ...
  static ButtonStyle get fillGrayC => ElevatedButton.styleFrom(
        backgroundColor: appTheme.gray9004c,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10.h),
        ),
      );
  ...
  static ButtonStyle get fillOrange => ElevatedButton.styleFrom(
        backgroundColor: appTheme.orange10002,
        shape: RoundedRectangleBorder(
  ...
  static ButtonStyle get fillPink => ElevatedButton.styleFrom(
        backgroundColor: appTheme.pink90066,
        shape: RoundedRectangleBorder(
  ...
  static BoxDecoration get gradientPurpleAToPinkA1Decoration => BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment(0.36, 0),
          end: Alignment(1.12, 1),
          colors: [
            appTheme.purpleA70001,
            appTheme.pinkA70072,
          ],
        ),
      );
  ...
  static ButtonStyle get outlineGrayTL251 => ElevatedButton.styleFrom(
        backgroundColor: appTheme.whiteA70001,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(25.h),
        ),
  ...
  static ButtonStyle get outlineLightBlueTL7 => OutlinedButton.styleFrom(
        backgroundColor: appTheme.lightBlue500,
        side: BorderSide(
          color: appTheme.lightBlue500,
          width: 1,
