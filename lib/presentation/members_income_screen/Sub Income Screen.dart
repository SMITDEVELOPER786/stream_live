...
class MembersSubIncomeScreen extends StatefulWidget {
  const MembersSubIncomeScreen({Key? key}) : super(key: key);

  @override
  _MembersSubIncomeScreenState createState() => _MembersSubIncomeScreenState();
}

class _MembersSubIncomeScreenState extends State<MembersSubIncomeScreen> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
      height: 50,
        ...
        centerTitle: true,
        title: Text("Sub Income Agent".tr,
           ));
  }
