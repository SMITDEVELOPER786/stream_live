...
import 'models/vip_one_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg_provider/flutter_svg_provider.dart' as fs;
import 'package:muhammad_zubair_s_application3/core/app_export.dart';

class VipOnePage extends StatelessWidget {
  VipOnePage({Key? key})
      : super(
          key: key,
        );
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                         decoration: BoxDecoration(
                          image: DecorationImage(image: NetworkImage("https://i.postimg.cc/Qt2KTVYy/Group.png",
                          ),
                          fit: BoxFit.cover)),
                        child: Column(
                          children: [
