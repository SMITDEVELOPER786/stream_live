import 'controller/rank_two_controller.dart';
import 'models/rank_two_model.dart';
import 'package:flutter/material.dart';
import 'package:muhammad_zubair_s_application3/core/app_export.dart';

class RankTwoPage extends StatelessWidget {
  RankTwoPage({Key? key})
      : super(
          key: key,
        );

  RankTwoController controller = Get.put(RankTwoController(RankTwoModel().obs));
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                       ...
                       Padding(
  padding: EdgeInsets.only(bottom: 10.v,left:0),
  child: Image.asset(
    ImageConstant.fire,
    height: 25.adaptSize,
    width: 25.adaptSize,
 ...
 Padding(
  ...
  /// Common widget
  Widget _buildAlexMedia({required String userBalance}) {
    return SizedBox(
      height: 17.v,
      width: 70.h,
      child: Stack(
