import '../family_screen/widgets/userprofile10_item_widget.dart';
...
import 'package:outline_gradient_button/outline_gradient_button.dart';
  ...
  @override
  _FamilyScreenState createState() =>
      _FamilyScreenState();
}

class _FamilyScreenState extends State<FamilyScreen> {
  var controller = Get.put(FamilyController());
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          SizedBox(
                                                                              ...
                                                                              child: Stack(alignment: Alignment.bottomLeft, children: [
                                                                                ...
                                                                                Align(alignment: Alignment.bottomRight, child: Padding(padding: EdgeInsets.only(right: 19.h, bottom: 2.v), child: Text("lbl_24h_30_mins".tr, style: CustomTextStyles.bodySmallDeeporange5002))),
  ...
  /// Section Widget
  PreferredSizeWidget _buildDoctorReviews() {
    return CustomAppBar(
        height: 101.v,
        centerTitle: true,
        title: SizedBox(
    ...
    return Align(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .familyModelObj.value.userprofile10ItemList.value.length,
            itemBuilder: (context, index) {
              Userprofile10ItemModel model = controller
                  .familyModelObj.value.userprofile10ItemList.value[index];
