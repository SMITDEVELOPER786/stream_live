import '../diamond_history_screen/widgets/userprofile13_item_widget.dart';import 'controller/diamond_history_controller.dart';import 'models/userprofile13_item_model.dart';import 'package:flutter/material.dart';import 'package:muhammad_zubair_s_application3/core/app_export.dart';import 'package:muhammad_zubair_s_application3/widgets/app_bar/appbar_leading_image.dart';import 'package:muhammad_zubair_s_application3/widgets/app_bar/appbar_subtitle_one.dart';import 'package:muhammad_zubair_s_application3/widgets/app_bar/custom_app_bar.dart';import 'package:muhammad_zubair_s_application3/widgets/custom_search_view.dart';class DiamondHistoryScreen extends GetWidget<DiamondHistoryController> {const DiamondHistoryScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildUserProfile() { return Obx(() => ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 16.v);}, itemCount: controller.diamondHistoryModelObj.value.userprofile13ItemList.value.length, itemBuilder: (context, index) {Userprofile13ItemModel model = controller.diamondHistoryModelObj.value.userprofile13ItemList.value[index]; return Userprofile13ItemWidget(model);})); } 
