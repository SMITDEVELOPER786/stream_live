...
class Userprofile6ItemModel {Userprofile6ItemModel({this.userImage, this.username, this.greeting, this.timeSinceLastActivity, this.notificationCount, this.id, }) { userImage = userImage  ?? Rx(ImageConstant.imgEllipse36);username = username  ?? Rx("Queen of Cali");greeting = greeting  ?? Rx("Good morning!");timeSinceLastActivity = timeSinceLastActivity  ?? Rx("1m");notificationCount = notificationCount  ?? Rx("3");id = id  ?? Rx(""); }
