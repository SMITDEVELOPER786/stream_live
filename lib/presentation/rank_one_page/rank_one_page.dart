import 'controller/rank_one_controller.dart';
import 'models/rank_one_model.dart';
import 'package:flutter/material.dart';
import 'package:muhammad_zubair_s_application3/core/app_export.dart';

class RankOnePage extends StatelessWidget {
  RankOnePage({Key? key})
      : super(
          key: key,
        );

  RankOneController controller = Get.put(RankOneController(RankOneModel().obs));
      ...
      child: Container(
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            //   image: DecorationImage(image:  AssetImage(ImageConstant.imgA504e96d9eac40e),
            //                 // height: 549.v,
            //                 // width: 393.h,
  ...
  Widget _buildFourColumn() {
    return Container(
      ...
      decoration: AppDecoration.gradientCyanToBlack.copyWith(
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: _buildKlipartzFifteenStack1(),
                ),
                Padding(
                  padding: EdgeInsets.only(
                    left: 8.h,
                 ...
                 Padding(
  padding: EdgeInsets.only(bottom: 10.v,left:5),
  child: Image.asset(
    ImageConstant.fire,
    height: 25.adaptSize,
    width: 25.adaptSize,
 ...
 Padding(
  ...
  /// Common widget
  Widget _buildAlexMedia({required String fifteenMillion}) {
    return SizedBox(
      height: 17.v,
      width: 70.h,
      child: Stack(
  ...
  /// Common widget
  Widget _buildKlipartzFifteenStack1() {
    return SizedBox(
      height: 38.v,
      width: 55.h,
      child: Stack(
