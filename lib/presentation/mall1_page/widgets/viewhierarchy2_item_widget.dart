...
class Viewhierarchy2ItemWidget extends StatelessWidget {
  ...
  var controller = Get.find<Mall1Controller>();
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Obx(
                    () => CustomImageView(
                      imagePath: viewhierarchy2ItemModelObj.jewelImage!.value,
                      height: 42.adaptSize,
                      width: 42.adaptSize,
                  ...
                  Obx(
                    () => Text(
                      viewhierarchy2ItemModelObj.jewelText!.value,
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              viewhierarchy2ItemModelObj
                                  .threeThousandText!.value,
