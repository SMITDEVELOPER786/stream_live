import '../invite_members_screen/widgets/userprofilelist1_item_widget.dart';
...
class _InviteMembersScreenState extends State<InviteMembersScreen> {
  final InviteMembersController controller =
      Get.put(InviteMembersController());
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: Text("lbl_members".tr,style: TextStyle(color: Colors.black,fontSize:23,fontWeight: FontWeight.bold),));
  ...
  Widget _buildUserProfileList() {
    return Padding(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller.inviteMembersModelObj.value
                .userprofilelist1ItemList.value.length,
            itemBuilder: (context, index) {
              Userprofilelist1ItemModel model = controller.inviteMembersModelObj
  ...
  Widget _buildFloatingActionButton() {
    return CustomFloatingButton(
        ...
        child: CustomImageView(
            imagePath: ImageConstant.imgPlus, height: 32.0.v, width: 32.0.h));
  }
