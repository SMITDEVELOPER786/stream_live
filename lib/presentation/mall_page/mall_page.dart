import '../mall_page/widgets/productcard_item_widget.dart';
    ...
    return SafeArea(
        child: Scaffold(
            body: Container(
                ...
                child: Column(
                    children: [SizedBox(height: 19.v), _buildProductCard()]))));
  }
  ...
  Widget _buildProductCard() {
    return Padding(
        ...
        child: Obx(() => GridView.builder(
            ...
            itemCount:
                controller.mallModelObj.value.productcardItemList.value.length,
            itemBuilder: (context, index) {
              ProductcardItemModel model = controller
                  .mallModelObj.value.productcardItemList.value[index];
