...
class FollowPage extends StatelessWidget {
  ...
  FollowController controller = Get.put(FollowController(FollowModel().obs));
      ...
      child: Padding(
        ...
        child: Obx(
          () => GridView.builder(
            ...
            itemCount:
                controller.followModelObj.value.followgridItemList.value.length,
            itemBuilder: (context, index) {
              FollowgridItemModel model = controller
                  .followModelObj.value.followgridItemList.value[index];
              return FollowgridItemWidget(
                model,
              );
            },
          ),
